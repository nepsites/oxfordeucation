...
export const metadata = {
  title: 'About Us | Oxford International Education Centre Nepal',
  description:
    'Learn about Oxford International Education Centre and Consultancy — established 2015 at Sukedhara Chowk, Kathmandu. Vision, mission, objectives, success history and registration details.',
  keywords:
    'about Oxford International Nepal, education consultancy Kathmandu, Sukedhara education Nepal, Lakpa Sherpa Oxford Nepal',
  alternates: { canonical: '/about' },
  openGraph: {
    title: 'About Us | Oxford International Education Centre Nepal',
    description:
      'Learn about Oxford International Education Centre and Consultancy — established 2015 at Sukedhara Chowk, Kathmandu. Vision, mission, objectives, success history and registration details.',
    url: 'https://oxfordeducation.com.np/about',
