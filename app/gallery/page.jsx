...
export const metadata = {
  title: 'Gallery | Oxford International Education Centre Nepal',
  description:
    'Photo gallery of Oxford International Education Centre — classrooms, student events, farewell ceremonies, study abroad seminars and campus life at Sukedhara Chowk, Kathmandu.',
  keywords:
    'Oxford International gallery Nepal, education centre Kathmandu photos, student life Nepal',
  alternates: { canonical: '/gallery' },
  openGraph: {
    title: 'Gallery | Oxford International Education Centre Nepal',
    description:
      'Photo gallery of Oxford International Education Centre — classrooms, student events, farewell ceremonies, study abroad seminars and campus life at Sukedhara Chowk, Kathmandu.',
    url: 'https://oxfordeducation.com.np/gallery',
