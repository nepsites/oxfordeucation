...
export const metadata = {
  title: 'Student Visa Assistance — Australia, UK, Japan, USA & More | Oxford International Nepal',
  description:
  ...
  alternates: { canonical: '/service-visa' },
  openGraph: {
    title:
      'Student Visa Assistance — Australia, UK, Japan, USA & More | Oxford International Nepal',
    description:
      'Complete education services: abroad study consultancy, IELTS/TOEFL prep, Japanese/Korean/German language courses, computer training, tuition, and personality development at Sukedhara, Kathmandu.',
    url: 'https://oxfordeducation.com.np/service-visa',
