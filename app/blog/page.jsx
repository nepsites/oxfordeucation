...
export const metadata = {
  title: 'Blog & News | Oxford International Education Centre Nepal',
  description:
    'Latest visa guidelines, scholarship opportunities, IELTS tips, and study abroad news for Nepali students. Expert insights from Oxford International counsellors.',
  keywords:
    'study abroad blog Nepal, IELTS tips Nepal, Australia visa Nepal, Japan scholarship Nepal, education news Nepal',
  alternates: { canonical: '/blog' },
  openGraph: {
    title: 'Blog & News | Oxford International Education Centre Nepal',
    description:
      'Latest visa guidelines, scholarship opportunities, IELTS tips, and study abroad news for Nepali students. Expert insights from Oxford International counsellors.',
    url: 'https://oxfordeducation.com.np/blog',
