...
export const metadata = {
  title: 'Australia Student Visa 2026 Guide for Nepali Students | Oxford International Nepal',
  description:
    'Complete guide to Australia Student Visa Subclass 500 for Nepali students in 2026: eligibility, required documents, Genuine Student (GS) requirement, step-by-step process and expert tips.',
  keywords:
    'Australia student visa Nepal, Subclass 500 Nepal, study Australia 2026, Genuine Student (GS) requirement Nepal, Australia visa requirements Nepal',
  alternates: { canonical: '/blog-australia-visa' },
  openGraph: {
    title: 'Australia Student Visa 2026 Guide for Nepali Students | Oxford International Nepal',
    description:
      'Complete guide to Australia Student Visa Subclass 500 for Nepali students in 2026: eligibility, required documents, Genuine Student (GS) requirement, step-by-step process and expert tips.',
    url: 'https://oxfordeducation.com.np/blog-australia-visa',
