...
export const metadata = {
  title: '10 Tips to Score 7+ Band in IELTS | Oxford International Nepal',
  description:
    "Proven IELTS preparation strategies from Oxford International's senior trainer. Learn how to achieve 7+ band score in Listening, Reading, Writing, and Speaking sections.",
  keywords:
    'IELTS tips Nepal, IELTS 7 band Nepal, IELTS preparation Kathmandu, IELTS coaching Nepal, how to score 7 IELTS',
  alternates: { canonical: '/blog-ielts-tips' },
  openGraph: {
    title: '10 Tips to Score 7+ Band in IELTS | Oxford International Nepal',
    description:
      "Proven IELTS preparation strategies from Oxford International's senior trainer. Learn how to achieve 7+ band score in Listening, Reading, Writing, and Speaking sections.",
    url: 'https://oxfordeducation.com.np/blog-ielts-tips',
