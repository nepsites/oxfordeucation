...
export const metadata = {
  title: 'MEXT Scholarship 2026 Guide for Nepali Students | Oxford International Nepal',
  description:
    'Complete guide to MEXT Monbukagakusho Scholarship 2026 for Nepali students — categories, eligibility, application timeline, research proposal tips and expert advice.',
  keywords:
    'MEXT scholarship Nepal, Japan scholarship 2026 Nepal, Monbukagakusho Nepal, study Japan free Nepal, JLPT Nepal',
  alternates: { canonical: '/blog-japan-scholarship' },
  openGraph: {
    title: 'MEXT Scholarship 2026 Guide for Nepali Students | Oxford International Nepal',
    description:
      'Complete guide to MEXT Monbukagakusho Scholarship 2026 for Nepali students — categories, eligibility, application timeline, research proposal tips and expert advice.',
    url: 'https://oxfordeducation.com.np/blog-japan-scholarship',
